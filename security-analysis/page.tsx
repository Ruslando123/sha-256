      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-6">
        <nav className="flex items-center justify-between gap-4 rounded-xl border border-zinc-200/80 bg-white/90 px-4 py-3 shadow-sm shadow-cyan-500/5 backdrop-blur-sm">
          <div className="min-w-0">
            ...
            >
              Birthday bound · collisions · risk view
            </motion.p>
          </div>
          <MotionLink
            href="/"
        ...
        {/* Section - Collision resistance and birthday paradox */}
        <AnimatedSection
          delay={0.03}
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="text-sm font-semibold text-zinc-900">Collision resistance and the birthday paradox</h2>
        ...
        <section className="grid gap-4 lg:grid-cols-3">
          {/* Card - Interactive collision estimate */}
          <AnimatedCard className="relative overflow-hidden rounded-2xl border border-sky-100 bg-gradient-to-br from-sky-50 via-cyan-50 to-blue-50 p-6 shadow-sm lg:col-span-2">
            ...
            <h3 className="relative text-sm font-semibold text-zinc-900">Interactive collision estimate</h3>
          ...
          <AnimatedCard className="relative overflow-hidden rounded-2xl border border-sky-100 bg-gradient-to-br from-sky-50 via-cyan-50 to-blue-50 p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm text-zinc-700">
              Roughly <span className="font-mono">2^(n/2)</span> messages:
            </p>
            <motion.p
              key={bits}
            ...
            <p className="mt-2 text-xs text-zinc-500">
              That is why “half the bits” is a practical rule of thumb for collision estimates.
            </p>
          </AnimatedCard>
        </section>
